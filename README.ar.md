...
| **2) طبقة الواجهة (سطح المكتب)** | سكربتات `patch/` (لينكس / ماك / ويندوز) | **حقل الكتابة المباشر** و**عناوين التبويبات/الجلسات** التي لا تصل إليها أي خطافات إضافة — عبر حقن `dir="auto"` + `unicode-bidi: plaintext` داخل `app.asar` |
...
- ✅ إصلاح بهمْسة عكس اتجاه النص في **عناوين التبويبات** (`[data-slot="tab-title"]`) وتبويبات الطرفية
